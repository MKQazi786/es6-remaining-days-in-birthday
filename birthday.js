setInterval(
    function remainingBirthday() {
        ...
        let forBirthYearFormula = new Date()

        
        let Birthday = forBirthYearFormula.setDate(date);
        Birthday = forBirthYearFormula.setMonth(newMonth);
        Birthday = forBirthYearFormula.setFullYear(year);

        currentFullDate = currentFullDate.getTime();

        let diffDate = currentFullDate - Birthday
        ...
        result = `You are now ${diffYear} Years, ${diffMonth} Months, and ${diffDay} Days`
